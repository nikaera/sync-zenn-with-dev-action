...
class ZennArticleService {
    ...
    createArticleRequest(article, option) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    formattedTitle(header, titleFormat) {
...
const DEVClient_1 = __nccwpck_require__(4375);
const ZennArticleService_1 = __nccwpck_require__(6216);
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            for (const filePath of markdownFilePaths) {
                ...
                const request = yield zennArticleService.createArticleRequest(article, { titleFormat });
